      ...
      <Row className="my-1 justify-content-end">
        <Col md={2} xs={12} className="text-end my-1">
          <Button
            ...
            onClick={() =>
              navigate(`/class/t4-selection/${classTeacher.alloted_class._id}`)
            }
          >
          ...
          <tbody>
            {filteredStudents.map((s) => (
              <tr key={s._id}>
                ...
                <td>{s.s_class.name}</td>
                <td>{s.s_class.stream}</td>
                <td>{s.t4.name}</td>
                <td>
                  {s.student.isActive ? (
                    <FontAwesomeIcon
                ...
                <td>
                  <LinkContainer
                    to={
                      userInfo.is_admin
                        ? `/admin/classes/t4-selection/student/${s.student.user}`
                        : `/class/t4-selection/student/${s.student.user}`
                    }
                  >
...
export default TechnicalSelections;
